...
path1 = 'D:/Alzheimer_Disease 100% Code (1)/train/4'    #path of folder of images    
path2 = 'D:/Alzheimer_Disease 100% Code (1)/training_set/4'  #path of folder to save images    
